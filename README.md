...
An object that defines thermal related configuration. Available for Jetson Orin devices running Jetpack 6 or newer.
...
configuration option should be set trough the API or from your balena-cloud dashboard.
...
An object that defines power consumption related configuration. Available for Jetson Orin devices running Jetpack 6 or newer.
...
configuration option should be set trough the API or from your balena-cloud dashboard, and it will cause a device reboot.
